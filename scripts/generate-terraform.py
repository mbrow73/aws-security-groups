...
class TerraformGenerator:
    ...
    def generate_all(self):
        ...
        print(f"🔧 Generating Terraform configuration for account {self.account_id}")
        print(f"📁 Output directory: {self.terraform_dir}")
...
Examples:
  ...
  python generate-terraform.py accounts/production
    ...
    try:
        ...
        if args.dry_run:
            print(f"🔍 Dry run mode - showing what would be generated for account {generator.account_id}")
            print(f"📁 Target directory: {generator.terraform_dir}")
        ...
        if existing_files and not args.force:
            print(f"⚠️  The following Terraform files already exist in {generator.terraform_dir}:")
